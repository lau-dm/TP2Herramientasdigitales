...
define config.name = _("Proyecto herramientas digitales")
...
define build.name = "Proyectoherramientasdigitales"
...
define config.save_directory = "Proyectoherramientasdigitales-1759327320"
